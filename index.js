...
switch (platform) {
  case 'android':
    switch (arch) {
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'exec.android-arm64.node'))
        try {
          if (localFileExisted) {
            nativeBinding = require('./exec.android-arm64.node')
          } else {
            nativeBinding = require('@alphahydrae/exec-android-arm64')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('./exec.android-arm-eabi.node')
          } else {
            nativeBinding = require('@alphahydrae/exec-android-arm-eabi')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'win32':
    switch (arch) {
      ...
      case 'ia32':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('./exec.win32-ia32-msvc.node')
          } else {
            nativeBinding = require('@alphahydrae/exec-win32-ia32-msvc')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('./exec.win32-arm64-msvc.node')
          } else {
            nativeBinding = require('@alphahydrae/exec-win32-arm64-msvc')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'darwin':
    ...
    switch (arch) {
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('./exec.darwin-arm64.node')
          } else {
            nativeBinding = require('@alphahydrae/exec-darwin-arm64')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'linux':
    switch (arch) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'exec.linux-arm64-musl.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'exec.linux-arm-musleabihf.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'exec.linux-arm-gnueabihf.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./exec.linux-arm-gnueabihf.node')
            } else {
              nativeBinding = require('@alphahydrae/exec-linux-arm-gnueabihf')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'exec.linux-riscv64-musl.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./exec.linux-riscv64-musl.node')
            } else {
              nativeBinding = require('@alphahydrae/exec-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, 'exec.linux-riscv64-gnu.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./exec.linux-riscv64-gnu.node')
            } else {
              nativeBinding = require('@alphahydrae/exec-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        ...
        try {
          if (localFileExisted) {
            nativeBinding = require('./exec.linux-s390x-gnu.node')
          } else {
            nativeBinding = require('@alphahydrae/exec-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
...
const { execvp, doNotCloseOnExit } = nativeBinding
